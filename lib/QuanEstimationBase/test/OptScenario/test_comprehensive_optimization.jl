...
function test_comprehensive_optimization()
    @testset "SCopt QFI" begin
        test_scopt_qfi()
    end
    @testset "SCopt QFIM" begin
        test_scopt_qfim()
    end
    @testset "CMopt QFI" begin
        test_cmopt_qfi()
    end
    @testset "CMopt QFIM" begin
        test_cmopt_qfim()
    end
    @testset "SMopt QFI" begin
        test_smopt_qfi()
    end
    @testset "SMopt QFIM" begin
        test_smopt_qfim()
    end
    @testset "SCMopt QFI" begin
        test_scmopt_qfi()
    end
    @testset "SCMopt QFIM" begin
        test_scmopt_qfim()
    end
end
